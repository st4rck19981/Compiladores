...
{
    /*
    Para poner vacios simplemente poner un dolar "$"
    Si pones " " un espacio en vez de un dolar, tomara el " " como un terminal
    y no lo tomara como un vacio
    No lee comillas o estados de tamano 2 como: "E'"
    cada estado y terminal debe ser de tamano1
    E'=A
    T'=B
    id=i
    */
	argv[1]="gramatica.txt";
	argv[2]="(i+i)";
